...
from authentication.views import UserRegisterView, UserLoginView, CustomTokenRefreshView, OTPVerificationView, UserLogoutView, UserForgetPasswordView, UserEmailExistsView
