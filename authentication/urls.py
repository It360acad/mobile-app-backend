...
from authentication.views import UserRegisterView, UserLoginView, CustomTokenRefreshView, OTPVerificationView, UserLogoutView, UserForgetPasswordView, UserResetPasswordView, UserEmailExistsView
...
urlpatterns = [ 
  ...
  path('email-exists/', UserEmailExistsView.as_view(), name='auth-email-exists'),
